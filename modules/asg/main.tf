...
# cloudwatch alarm to decrease  instances if cpu utilization is below 5%
resource "aws_cloudwatch_metric_alarm" "scale_in_alarm" {
  alarm_description   = "CPU utilization Monitoring for Webserver ASG"
  alarm_actions       = [aws_autoscaling_policy.scale_in_policy.arn]
  alarm_name          = "webserver_scale_in"
...
# cloudwatch alarm to decrease  instances if cpu utilization is above  5%
resource "aws_cloudwatch_metric_alarm" "scale_out_alarm" {
  alarm_description   = "CPU utilization Monitoring for Webserver ASG"
  alarm_actions       = [aws_autoscaling_policy.scale_out_policy.arn]
  alarm_name          = "webserver_scale_out"
